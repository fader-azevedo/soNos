...
class InscricaoController extends Controller{
    public function getInscricao(){
        $inscricao = Inscricao::query()
            ...
            ->join('disciplinas','inscricaos.idCurso','=','disciplinas.id')
            ->join('contactos','alunos.idContacto','=','contactos.id')
            ->select('disciplinas.*','disciplinas.nome as disciplina','disciplinas.id as idDisciplina','alunos.foto as picture','alunos.*','contactos.*')
